...
class Volume(QWidget):
    def __init__(self, text: str, parent=None):
        ...
        self.titleLabel.setText("Найти объем конуса")
    ...
    def solution(self):
        ...
        text = f'''Формула для объема конуса:
        • V = π ⋅ r² ⋅ h / 3 = {math.pi} ⋅ {arr[1]}² ⋅ {arr[0]} / 3 = {arr[2]}
        '''
...
class FullSquare(QWidget):
    def __init__(self, text: str, parent=None):
        ...
        self.titleLabel.setText("Найти площадь полной поверхности конуса")
        self.titleLabel.setAlignment(Qt.AlignCenter)
        self.titleLabel.setFont(self.customFont)

        self.radius.setPlaceholderText("Радиус")
        self.height.setPlaceholderText("Образующая")
    ...
    def calculateSquare(self):
        ...
        square = math.pi * r * r + math.pi * r * h
    ...
    def solution(self):
        ...
        text = f'''Формула для площади полной поверхности конуса:
        • S = π ⋅ r ⋅ (l + r) = {math.pi} ⋅ {arr[1]} ⋅ ({arr[0]} + {arr[1]}) = {arr[2]}
        '''
        self.solutionLabel.setText(text)
...
class SideSquare(QWidget):
    def __init__(self, text: str, parent=None):
        ...
        self.titleLabel.setText("Найти площадь боковой поверхности конуса")
        self.titleLabel.setAlignment(Qt.AlignCenter)
        self.titleLabel.setFont(self.customFont)
    ...
    def solution(self):
        ...
        text = f'''Формула для площади боковой поверхности конуса:
        • S = π ⋅ r ⋅ l = {math.pi} ⋅ {arr[1]} ⋅ {arr[0]} = {arr[2]}
        '''
        self.solutionLabel.setText(text)